...
test('İptal, alt işlemi de durdurur ve arka planda iş bırakmaz', { timeout: 10000 }, async () => {
  ...
  await assert.rejects(runProcess(process.execPath, ['-e', parentCode], { signal: controller.signal, onLine: () => controller.abort() }), /durduruldu/);
